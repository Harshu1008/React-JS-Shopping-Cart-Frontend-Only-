...
{ id: 3, pdtname: 'shirt', imgurl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTDIbTlamFtG7GXmos93hCOwz7GAc-WKwc64w&s', size: 17, qty: 10, price: 649 },
{ id: 4, pdtname: 'shirt', imgurl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRkP1tA5fTQeCTUtKdI9BYTwur5ubTOxXCYWg&s', size: 18, qty: 11, price: 649 },
{ id: 5, pdtname: 'shirt', imgurl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTO5ZXgQoXi29CTxHRd487CAexRH2Vq2E3td51Jd9YOgw&s', size: 14, qty: 7, price: 749 },
                ...
                <div className="cart-summary">
                    ...
                    {cartItems.map((cartItem, index) => (
                        <div key={index} className="cart-item-summary">
                            <img src={cartItem.product.imgurl} alt="img" className="cart-item-img" />
                            <div className="cart-item-details">
                                <p>{cartItem.product.pdtname}</p>
                                <p>Size: {cartItem.product.size}</p>
                                <p>Cost: Rs. {cartItem.product.price}</p>
